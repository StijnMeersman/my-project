        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TimesheetWeeks_People_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_ProjectId_PersonId",
                table: "Assignments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_People_NormalizedEmail",
                table: "People",
                column: "NormalizedEmail",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Projects_ClientId_NormalizedName",
                table: "Projects",
                columns: new[] { "ClientId", "NormalizedName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TimeEntries_PersonId_ProjectId_Date",
                table: "TimeEntries",
                columns: new[] { "PersonId", "ProjectId", "Date" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimesheetWeeks_PersonId_WeekStartDate",
